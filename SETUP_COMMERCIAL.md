# 🚀 MISE EN PLACE RAPIDE - Protection Auth pour Commercial

## 📋 Étapes à suivre

### 1️⃣ Créer la configuration des URLs

**Créer le fichier:** `/var/www/commercial/config/app_urls.php`
...
**Ajouter dans:** `/var/www/commercial/.env`
...
**Ajouter AU DÉBUT du fichier:** `/var/www/commercial/routes/web.php`
...
**Créer:** `/var/www/commercial/app/Http/Middleware/Authenticate.php`
...
1. Ouvrir le navigateur: `http://localhost/commercial`
2. Devrait rediriger vers `http://localhost/administration/auth/login?site=commercial`
3. Se connecter avec vos identifiants
4. Devrait revenir sur `http://localhost/commercial/dashboard`
